...
CREATE TABLE `entry_warehouse_management`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '入库主键',
  `entry_order_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '入库订单号',
  `entry_goods_id` bigint(0) NOT NULL COMMENT '入库商品编号',
  `entry_goods_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '入库商品名',
  `entry_goods_number` bigint(0) NOT NULL COMMENT '入库商品数量',
  `entry_goods_time` timestamp(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '入库商品时间',
  `before_entry_goods_number` bigint(0) NOT NULL COMMENT '入库之前商品数量',
  `after_entry_goods_number` bigint(0) NOT NULL COMMENT '入库之后商品数量',
...
CREATE TABLE `goods_management`  (
  `goods_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '货物主键',
  `goods_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '货物名字',
  `goods_number` bigint(0) NOT NULL COMMENT '货物数量',
  `yesterday_goods_number` bigint(0) DEFAULT 0 COMMENT '昨天货物数量',
  `last_week_goods_number` bigint(0) DEFAULT 0 COMMENT '上周货物数量',
  `last_month_goods_number` bigint(0) DEFAULT 0 COMMENT '上月货物数量',
  `last_quarter_goods_number` bigint(0) DEFAULT 0 COMMENT '上季度货物数量',
  `last_year_goods_number` bigint(0) DEFAULT 0 COMMENT '去年货物数量',
  `last_operator_id` bigint(0) NOT NULL COMMENT '最后一位操作该货物的操作员id',
  `quantity_ceiling` bigint(0) NOT NULL COMMENT '货物上限',
  `quantity_floor` bigint(0) NOT NULL COMMENT '货物下限',
  `goods_status_id` int(0) NOT NULL COMMENT '库存状态id',
...
-- ----------------------------
INSERT INTO `goods_management` VALUES (1, 'macbook pro', 100, 0, 0, 0, 0, 0, 1, 1000, 20, 0, '2021-04-04 00:00:00', '2021-04-04 00:00:00');
INSERT INTO `goods_management` VALUES (2, 'iphone12', 100, 0, 0, 0, 0, 0, 1, 1000, 20, 0, '2021-04-04 00:00:00', '2021-04-04 00:00:00');
INSERT INTO `goods_management` VALUES (3, 'ipad Air4', 101, 0, 0, 0, 0, 0, 1, 0, 500, 1, '2021-04-08 20:18:29', '2021-04-08 20:18:29');
INSERT INTO `goods_management` VALUES (4, 'Apple Watch', 100, 0, 0, 0, 0, 0, 1, 500, 0, 1, '2021-04-08 20:42:46', '2021-04-08 20:42:46');
INSERT INTO `goods_management` VALUES (5, 'Airports', 1000, 0, 0, 0, 0, 0, 1, 1000, 0, 2, '2021-04-08 20:45:24', '2021-04-08 20:45:24');
...
CREATE TABLE `goods_status_management`  (
  `goods_status_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '货物状态主键',
  `goods_status` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '货物状态',
  `goods_status_desc` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '货物状态描述',
  PRIMARY KEY (`goods_status_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `out_warehouse_management`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '出货主键',
  `out_order_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '出库订单号',
  `out_goods_id` bigint(0) NOT NULL COMMENT '出货商品编号',
  `out_goods_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '出货商品名',
  `out_goods_number` bigint(0) NOT NULL COMMENT '出货商品数量',
  `out_goods_time` timestamp(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '出货商品时间',
  `before_out_goods_number` bigint(0) NOT NULL COMMENT '出货前商品数量',
  `after_out_goods_number` bigint(0) NOT NULL COMMENT '出货后商品数量',
  `operator_id` bigint(0) NOT NULL COMMENT '操作员Id',
  `create_time` timestamp(0) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `permission_management`  (
  `permission_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '级别主键',
  `permission_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '级别名称',
  `permission_description` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '具体权利描述',
  `responsibility` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '职责',
...
CREATE TABLE `personnel_management`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '人员主键',
  `user_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名',
  `user_password` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '123456' COMMENT '密码',
  `permission_level` int(0) NOT NULL COMMENT '人员级别,0超级管理员，1管理员，2普通员工',
  `name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '人员姓名',
  `age` int(0) DEFAULT NULL COMMENT '人员年龄',
  `tel` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '人员电话',
  `sex` tinyint(0) NOT NULL COMMENT '性别',
  `join_time` date NOT NULL COMMENT '加入时间',
  `authorize` tinyint(0) NOT NULL COMMENT '是否授权',
  PRIMARY KEY (`id`) USING BTREE
